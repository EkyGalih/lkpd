...
@section('content')
    ...
    <hr />
    <a href="{{ route('rincian-iku-pegawai') }}" class="btn btn-default btn-sm"><i class="fas fa-backward"></i> Kembali</a>
    <div class="row mt">
        <div class="col-lg-12">
            <div class="col-lg-6">
                <div class="content-panel">
                    <div class="container">
                        <form action="{{ route('rincian-iku-pegawai.upload') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <tbody>
                            @for ($i = 0; $i < $explode[0]; $i++)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="{{ asset($ListFile[$i]['nama_file'] ?? route('rincian-iku-pegawai.show', $SubKegiatan->id)) }}">
