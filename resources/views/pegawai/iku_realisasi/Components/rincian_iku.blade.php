...
@section('content')
    <h3><a href="{{ route('rincian-iku-pegawai') }}"><i class="fas fa-info"></i> Rincian Iku Realisasi</a></h3>
    <hr />
    <div class="row mt">
        ...
        <div class="col-lg-1">
            ...
            @include('pegawai.iku_realisasi.Addons.RincianIku.import')
        </div><br /><br />
        <div class="col-lg-12">
                                            ...
                                            @foreach ($SubKegiatan as $item)
                                                ...
                                                <ol style="list-style-type: inherit">
                                                    ...
                                                    <li style="color: {{ $item->persentase == 100 ? 'green' : 'red' }}; font-size: 14px;">{{ $item->target_kinerja }}
                                                        <a href="{{ route('rincian-iku-pegawai.show', $item->id) }}" class="btn btn-link btn-xs">
                                                            Lihat Rincian
                                                        </a>
                                                    </li>
                                                </ol>
