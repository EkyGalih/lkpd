...
@section('content')
<h3><a href="{{ route('kode-rekening-pegawai') }}"><i class="fas fa-barcode"></i> Kode Rekenings</a></h3>
<div class="row mt">
    <div class="col-lg-8">
                ...
                <table class="table table-hover table-bordered table-striped" id="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $rekening->ref }}</td>
                            <td>
                                <a href="{{ route('kode-rekening-pegawai', $rekening->rekening_id) }}" class="btn btn-warning btn-xs" data-tooltip="tooltip" data-placement="top" title="Edit Kode Rekening">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button" class="btn btn-danger btn-xs" data-tooltip="tooltip" data-placement="top" title="Hapus Kode Rekening" onclick="deleteData('{{ route('kode-rekening-pegawai.destroy', $rekening->rekening_id) }}')">
    ...
    <div class="col-lg-4">
        <div class="content-panel" style="padding: 10px;">
            <form action="{{ isset($rekeningDetail) ? route('kode-rekening-pegawai.update', $rekeningDetail->rekening_id) : route('kode-rekening-pegawai.store') }}" method="POST" onsubmit="return validateForm()">
                @csrf
                ...
                @if (isset($rekeningDetail))
                <a href="{{ route('kode-rekening-pegawai') }}" class="btn btn-warning btn-sm"><i class="fas fa-sync"></i> Reset</a>
                @endif
            </form>
                ...
                <div class="modal-dialog modal-sm" style="margin-top: 14%">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('kode-rekening-pegawai.import') }}" method="POST" enctype="multipart/form-data">
                                @csrf
