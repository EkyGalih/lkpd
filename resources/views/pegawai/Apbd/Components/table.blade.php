<div class="content-panel">
    <div class="row">
        ...
        <div class="col-lg-1">
            <button type="button" class="btn btn-success" data-tooltip="tooltip" data-placement="top" title="Download Data" data-toggle="modal" data-target="#modalImport">
        ...
        <tbody>
            ...
            @foreach ($Apbd as $apbd)
                ...
                @foreach ($apbd['data'] as $item)
                    ...
                    @include('pegawai.Apbd.Components.edit')
                    @endif
                    @php
