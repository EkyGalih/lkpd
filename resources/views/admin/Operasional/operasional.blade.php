...
@section('operasional', 'active')

@section('css-additional')
<link rel="stylesheet" href="{{ asset('lib/bootstrap-fileupload/bootstrap-fileupload.css') }}">
@endsection
@section('content')
<h3><a href="{{ route('operasional-admin') }}"><i class="fas fa-cash-register"></i> Laporan Operasional</a></h3>
<hr/>
<div class="row mt">
    <div class="col-lg-6">
        <div class="content-panel">
            <div class="row">
                <div class="col-lg-8">
                    <h4 class="title"><i class="fas fa-list"></i> Data Operasional</h4>
                </div>
                <div class="col-lg-4">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content" style="margin-top: 14%;">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('operasional-admin.import') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
