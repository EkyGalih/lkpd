    ...
    <!-- **********************************************************************************************************************************************************
        ...
        *********************************************************************************************************************************************************** -->
        <div class="col-lg-3 ds">
            ...
            <div class="desc">
                <div class="thumb">
                    <span class="badge bg-info"><i class="fa fa-clock"></i> <muted>{{ $jadwal->jam_acara }}</muted></span>
                </div>
                <div class="details">
                    <p>
                        <br/>
                        ...
                        <p>
                            ...
                            <span style="float: right; margin-top: 20px; font-size: 12px"><i class="fas fa-map-marker"></i> {{$jadwal->lokasi_acara}}</span>
                        </p>
                    </p>
                </div>
            </div>
