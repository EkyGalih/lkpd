...
@endsection
@section('content')
<h3><a href="{{ route('realisasi-anggaran-admin') }}"><i class="fas fa-cash-register"></i> Laporan Realisasi Anggaran</a></h3>
<hr/>
<div class="row mt">
    <div class="col-lg-8">
            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('arus-kas-admin.index', $arus_masuk['arus_kas_id']) }}" class="btn btn-warning btn-xs" data-tooltip="tooltip" data-placement="top" title="Edit Uraian">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a type="button" class="btn btn-danger btn-xs" data-tooltip="tooltip" data-placement="top" title="Hapus Uraian" onclick="deleteData('{{ route('arus-kas-admin.destroy', $arus_masuk['arus_kas_id']) }}')">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('arus-kas-admin.index', $arus_keluar['arus_kas_id']) }}" class="btn btn-warning btn-xs" data-tooltip="tooltip" data-placement="top" title="Edit Uraian">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a type="button" class="btn btn-danger btn-xs" data-tooltip="tooltip" data-placement="top" title="Hapus Uraian" onclick="deleteData('{{ route('arus-kas-admin.destroy', $arus_keluar['arus_kas_id']) }}')">
                                <i class="fas fa-trash"></i>
                            </a>
                        </td>
                    </tr>
    ...
    <div class="col-lg-4">
        <div class="content-panel">
            ...
            <hr/>
            <form method="POST" action="{{ isset($edit) ? route('arus-kas-admin.update', $edit->arus_kas_id) : route('arus-kas-admin.store') }}" style="margin-left: 10px; margin-right: 10px;">
                @csrf
                @if (isset($edit))
                @method('PUT')
                @endif
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="tahun_anggaran1" class="form-control" onchange="getTahun()" id="tahun_anggaran1" value="{{ isset($edit) ? $edit->tahun_anggaran : '' }}" onkeypress="isInputNumber(event)">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="anggaran" id="anggaran">Anggaran</label>
                            <input type="text" name="anggaran" id="anggaran" class="form-control" value="{{ isset($edit) ? $edit->anggaran : '' }}" onchange="subTotal1()">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="realisasi_anggaran" id="realisasi_anggaran" class="form-control" value="{{ isset($edit) ? $edit->anggaran : '' }}" onchange="subTotal1()">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="persen" class="form-control" value="{{ isset($edit) ? $edit->tahun_anggaran_sebelum : '' }}" id="persen" onkeypress="isInputNumber(event)">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="realisasi_anggaran2" id="realisasi_anggaran2">Realisasi Anggaran</label>
                            <input type="text" name="anggaran_tahun_sebelum" id="realisasi_anggaran2" class="form-control" value="{{ isset($edit) ? $edit->anggaran_tahun_sebelum : '' }}" onchange="subTotal2()">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_total_saldo1" value="{{ isset($edit) ? $edit->sub_total_saldo1 : '' }}" class="form-control" id="sub_total_value_1" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="total_saldo" id="sub_total_2">Sub Total SILPA </label>
                            <input type="text" name="sub_total_saldo2" id="sub_total_value_2" value="{{ isset($edit) ? $edit->sub_total_saldo2 : '' }}" class="form-control" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="total_saldo1" id="total_value_1" class="form-control" value="{{ isset($edit) ? $edit->total_saldo1 : '' }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="total_saldo" id="total_2">Total SILPA </label>
                            <input type="text" name="total_saldo2" id="total_value_2" class="form-control" value="{{ isset($edit) ? $edit->total_saldo2 : '' }}" readonly>
                        </div>
                    </div>
