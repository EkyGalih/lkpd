                ...
                @foreach ($apbd['data'] as $item)
                    @if ($apbd['kode_rekening'] != $item['kode_rekening'])
                        <tr>
                            ...
                            @if (isset($item['nama_rekening']) && !isset($item['sub_uraian']))
                                ...
                                <td style="text-align: right; font-size: 14px;">
                                    {{-- <strong>{{ number_format($item['anggaran_terealisasi']) }}</strong> --}}
                                </td>
                                <td style="text-align: right; font-size: 14px;">
                    ...
                    @php
                        if (strlen($item['kode_rekening']) == 3 && $item['nama_rekening'] == strtoupper('pendapatan daerah')) {
                            ...
                            array_push($realisasi_pembiayaan1, $item['anggaran_terealisasi']);
                            ...
                            array_push($realisasi_pembiayaan2, $item['anggaran_terealisasi']);
                        }
                    @endphp
                @endforeach
                <tr>
