...
@endsection
@section('content')
<h3><a href="{{ route('neraca-admin') }}"><i class="fas fa-cash-register"></i> Laporan Neraca</a></h3>
<hr/>
<div class="row mt">
    <div class="col-lg-6">
        <div class="content-panel">
            <div class="row">
                <div class="col-lg-8">
                    <h4 class="title"><i class="fas fa-list"></i> Data Neraca</h4>
                </div>
                <div class="col-lg-4">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content" style="margin-top: 14%;">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('neraca-admin.import') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
