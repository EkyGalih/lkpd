...
class KodeRekeningController extends Controller
{
    ...
    */
    public function index($id = null)
    {
        ...
        if ($id == null){
            return view('admin.KodeRekening.KodeRekening', compact('kodeRekening', 'jenis_rekening'));
        } else {
    ...
    */
    public function store(Request $request)
    {
        ...
        if (isset($cek_rekening))
        {
            ...
            return redirect()->route('kode-rekening-admin')->with(['success' => 'Kode Rekening Ditambahkan!']);
        }
    }
    ...
    */
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kode-rekening-admin')->with(['success' => 'Data berhasil diubah!']);
    }
    ...
    */
    public function destroy($id)
    {
        ...
        return redirect()->route('kode-rekening-admin')->with(['success' => 'Data Dihapus!']);
    }
}
