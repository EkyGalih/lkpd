...
class RincianIkuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pegawai.iku_realisasi.Components.rincian_iku', compact('KegiatanIku'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pegawai.iku_realisasi.Components.detail_rincian_iku', compact('SubKegiatan'));
    }
