...
class IndikatorKinerjaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pegawai.iku_realisasi.Components.indikator-kinerja', compact('indikatorKinerja'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('iku-indikator-pegawai')->with(['success' => 'Data berhasil disimpan!']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('iku-indikator-pegawai')->with(['success' => 'Data Berhasil Diubah!']);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('iku-indikator-pegawai')->with(['success' => 'Data Berhasil Dihapus!']);
    }
}
