...
class RealisasiAnggaranController extends Controller
{
    ...
    public function index($tahun = null)
    {
        ...
        return view('pegawai.RealisasiAnggaran.realisasi-anggaran', compact('user', 'Apbd', 'kodeRekening', 'get_tahun', 'tahun_anggaran'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($Apbd->jml_anggaran_setelah >= $SumAnggaran) {
            ...
            return redirect()->route('realisasi-anggaran-pegawai')->with(['success' => 'Anggaran Berhasil Diupdate!']);
        } elseif ($Apbd->jml_anggaran_setelah < $SumAnggaran) {
            $Anggaran->update([
                'anggaran_terealisasi' => $SumAnggaran
            ]);
            return redirect()->route('realisasi-anggaran-pegawai')->with(['warning' => 'Anggaran Berhasil Diupdate, Tapi melebihi Pagu']);
        }
    }
